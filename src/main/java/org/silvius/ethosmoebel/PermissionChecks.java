...
public class PermissionChecks {
    final static LandsIntegration api = LandsIntegration.of(EthosMoebel.getPlugin());

    public static boolean hasBreakPermission(Player player, Block block) {
    ...
    public static boolean hasPlacePermission(Player player, Block block) {
        if(player.isOp()){return true;}
